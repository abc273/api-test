...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		portraitAssetRoute := apiRouter.Group("/portrait_assets")
		{
			...
			portraitAssetRoute.GET("/virtual/config", middleware.TokenOrUserAuth(), controller.GetVirtualPortraitAssetConfig)
			portraitAssetRoute.GET("/virtual/group", middleware.TokenOrUserAuth(), controller.GetUserVirtualPortraitAssetGroup)
			portraitAssetRoute.GET("/virtual/assets", middleware.TokenOrUserAuth(), controller.ListUserVirtualPortraitAssets)
