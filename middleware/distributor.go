...
func Distribute() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if ok {
			...
			// Fetch/remix and other non-selection routes can legitimately omit the model name.
			// Those requests are authorized by task ownership or locked-channel flow instead.
